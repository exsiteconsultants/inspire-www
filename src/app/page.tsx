  ...
  return (
    <div className={styles.homepage}>
      <main>
            ...
            <div data-team="u12" className={styles.teamContent}>
              ...
              <Content>
                ...
                <p>
                  ...
                  such as Crystal Palace. The team also plays in cups and
                  premiere tournaments across the UK.
                </p>
              </Content>
            </div>
          )}
            ...
            <div data-team="u13" className={styles.teamContent}>
              ...
              <Content>
                ...
                <p>
                  ...
                  tactics and how they apply to each players position. The team
                  is further supported in areas of fitness, strenth and
                  conditioning.
                </p>
              </Content>
            </div>
            ...
            <div data-team="u15" className={styles.teamContent}>
              ...
              <Content>
                <p>
                  ...
                  2022 to take provide a route for players that wanted to
                  progress out of grassroots football and into a more
                  competitive environment.
                </p>
                <p>
                  The team has now been expanded and improved, following a
                  successful summer trial process, and are once again competing
                  in the JPL Warrior league at the highest level.
                </p>

                <p>
                  The under 15&apos;s team trains twice a week regular JPL
                  league games, county cups and premiere tournaments across the
                  UK.
                </p>
              </Content>
            </div>
            ...
            <div data-team="u16" className={styles.teamContent}>
              ...
              <Content>
                <p>
                  ...
                  perform at an elite level and provide a pathway into a career
                  in sport. During their first year they found great success in
                  the JPL Warrior league and continue into the 2023/24 season
                  with their coac Sophie Hollis with there sights set on winning
                  the league.
                </p>
              </Content>
            </div>
        ...
        <Content>
          <p>
            Inspire Girls Academy&apos;s ultimate goal is to INSPIRE, develop
            and empower female players to be able to reach their highest
            potential, while helping create leaders and individuals, that will
            inspire others to do the same. Our core values are &apos;Respect,
            Honesty and Integrity&apos;, and we believe that a positive attitude
